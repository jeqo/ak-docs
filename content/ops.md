...
##### []{#kraft_controller_monitoring .anchor-link}[KRaft Controller Monitoring Metrics](#kraft_controller_monitoring) {#kraft-controller-monitoring-metrics .anchor-heading}
...
##### []{#kraft_broker_monitoring .anchor-link}[KRaft Broker Monitoring Metrics](#kraft_broker_monitoring) {#kraft-broker-monitoring-metrics .anchor-heading}
...
### []{#kraft .anchor-link}[6.10 KRaft](#kraft) {#kraft .anchor-heading}

#### []{#kraft_config .anchor-link}[Configuration](#kraft_config) {#configuration .anchor-heading}

##### []{#kraft_role .anchor-link}[Process Roles](#kraft_role) {#process-roles .anchor-heading}
...
##### []{#kraft_voter .anchor-link}[Controllers](#kraft_voter) {#controllers .anchor-heading}
...
#### []{#kraft_storage .anchor-link}[Storage Tool](#kraft_storage) {#storage-tool .anchor-heading}
...
#### []{#kraft_debug .anchor-link}[Debugging](#kraft_debug) {#debugging .anchor-heading}

##### []{#kraft_metadata_tool .anchor-link}[Metadata Quorum Tool](#kraft_metadata_tool) {#metadata-quorum-tool .anchor-heading}
...
##### []{#kraft_dump_log .anchor-link}[Dump Log Tool](#kraft_dump_log) {#dump-log-tool .anchor-heading}
...
##### []{#kraft_shell_tool .anchor-link}[Metadata Shell](#kraft_shell_tool) {#metadata-shell .anchor-heading}
...
#### []{#kraft_deployment .anchor-link}[Deploying Considerations](#kraft_deployment) {#deploying-considerations .anchor-heading}
...
#### []{#kraft_missing .anchor-link}[Missing Features](#kraft_missing) {#missing-features .anchor-heading}
